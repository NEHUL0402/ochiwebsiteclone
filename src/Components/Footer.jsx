...
const Footer = () => {
  return (
    <div className="w-full h-screen rounded-t-2xl p-20 flex justify-between text-9xl font-bold ">
      <div className="w-1/2 h-full relative">
        <div className="w-1/2">
          <h1 className="tracking-tighter">EYE-OPENING</h1>
        </div>
      ...
      <div className="w-1/2 h-full">
        <h1 className="tracking-tighter text-8xl">PRESENTATIONS</h1>
        <div className="flex justify-between">
          <div>
            <button className="text-xl font-normal">S:</button>
            {["behance", "linkdin", "facebook", "Instagram"].map(
              (item, index) => {
                return (
                  <button
                    key={index}
                    className="animated-underline capitalize cursor-pointer block font-normal text-xl"
                  >
                    {item}
                  </button>
                );
            ...
            <button className="text-xl font-normal">L:</button>
            {["behance", "linkdin", "facebook", "Instagram"].map(
              (item, index) => {
                return (
                  <button
          ...
          <div className="lastdiv mt-[10vw]">
          <button className="text-xl font-normal">M:</button>
            {[
              "home",
              "services",
              "our work",
              ...
              return (
                <button
                  key={index}
                  className="animated-underline cursor-pointer capitalize block font-normal text-xl"
                >
                  {item}
                </button>
              );
